...
import { addResourseData, addTableData, addTopologyData } from "@/pages/api/addTopology";
  ...
  return (
    <>
      ...
      <div className="flex flex-row overflow-hidden w-full relative">
        ...
        <form className={!nextForm ? "relative overflow-hidden w-full" : "hidden"}>
        ...
        {nextForm &&
          <form className={"overflow-hidden w-full z-10"}>
            <div className={loading ? "loader" : "hidden"}></div>
            <div className="mt-4 p-2 box-border w-full bg-white">
              <div className="form-inputs px-2 space-y-3">
                <h1 className="text-xl">Additional Info - {allNodes}</h1>

                <div className="flex justify-around">
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                ...
                <div className="flex justify-around">
                  ...
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                    <div>Description :</div>
                    <textarea
                      className="w-[10rem] min-h-[1.7rem] h-[1.7rem]"
                      onChange={(e) => {
                        setServerData({
                          ...serverData,
                ...
                <div className="flex justify-around">
                  ...
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                    ...
                    <select value={serverData?.Compute_options}
                      onChange={(e) => {
                        setServerData({
                          ...serverData,
                  ...
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                    ...
                    <input
                      ...
                      disabled={serverData?.Compute_options == "no" ? true : false}
                      onChange={(e) => {
                        setServerData({
                          ...serverData,
                ...
                <div className="flex justify-center gap-[6.5rem]">
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                    ...
                    <select value={serverData?.Internet_facing}
                      onChange={(e) => {
                        setServerData({
                          ...serverData,
                  ...
                  <label htmlFor="" className="font-semibold text-base flex flex-col justify-start">
                    <div>NATting :</div>
                    <select value={serverData?.NATting}
                      onChange={(e) => {
                        setServerData({
                          ...serverData,
