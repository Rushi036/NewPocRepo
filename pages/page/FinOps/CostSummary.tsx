...
function CostSummary() {
    ...
    const dummyData2: any = {
        ...
        "type": "column",
        "stacking": "false",
        "categories": ["47239", "749203", "18209", "89232", "72893", "12891", "732901", "74293"],
        "data": [
            {
                "name": "",
    ...
    const dummyData3: any = {
        ...
        "type": "column",
        "stacking": "false",
        "categories": ["EastUS", "CentralUS", "WestUS", "India", "SouthUS", "AllRegions"],
        "data": [
            {
                "name": "",
        ...
        <TabContext value={cloudValue}>
            <div className="cloud-tabs flex w-full h-full">
                <div className=" mb-4 rounded-lg">
                    <Tabs value={cloudValue} onChange={CloudChange} centered orientation="vertical">
                        <Tab value={"aws"} label="AWS" className="bg-white border border-[#D5C5EE] border-solid !text-black !rounded-lg mb-2 !max-h-[5rem] !h-[5rem]" />
                        <Tab value={"azure"} label="Azure" className="border border-[#D5C5EE] bg-white border-solid !text-black !rounded-lg mb-2 !max-h-[5rem] !h-[5rem]" />
                        <Tab value={"google"} label="Google" className="border border-[#D5C5EE] bg-white border-solid !text-black !rounded-lg mb-2 !max-h-[5rem] !h-[5rem]" />
                        <Tab value={"4"} label="Default" className="border border-[#D5C5EE] bg-white border-solid !text-black !rounded-lg mb-2 !max-h-[5rem] !h-[5rem]" />
                    </Tabs>
                </div>
